        ...
        <div className="container mb-5 container-fluid" style={{paddingLeft:'0px', paddingRight:'0px'}}>
            <DappRow>
                <div className="row" style={{ width: '100%', paddingLeft:'0px', paddingRight:'0px' }}>
                    <DappInfoContainer className="col col-lg-4 col-md-3 my-2 my-md-0">
                    ...
                    <DappInfoContainer className="col col-lg-4 col-md-3 my-2 my-md-0 dapp-block" style={{ width: '100%' }}>
            ...
            <DappRow>
                <div className="row" style={{ width: '100%'}}>
                    ...
                    <DappInfoContainer className="col col-lg-4 col-md-3 my-2 my-md-0" style={{ width: '100%' }}>
                        <section className="dapp-block d-flex flex-column justify-content-evenly align-items-center">
                            <div className="row w-75">
                                <div className="col">
